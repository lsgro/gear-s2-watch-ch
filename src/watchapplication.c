...
create_base_gui(appdata_s *ad, int width, int height)
{
	...
	ad->bg_surface = cairo_image_surface_create_from_png("/opt/usr/apps/com.luigisgro.anotherwatch/res/images/clear_bg.png");
	ad->amb_bg_surface = cairo_image_surface_create_from_png("/opt/usr/apps/com.luigisgro.anotherwatch/res/images/dark_bg.png");
